...
def fetch_open_signals_for_open_registry(conn: psycopg.Connection, symbol: str) -> List[Dict[str, Any]]:
    """
            ...
            rows.append(
                {
                    ...
                    "bios_at_open": bios_at_open,
                    "sl_time": sl_time,
                    "actual_target_pips": actual_target_pips,
                    "trailing_tp_price": trailing_tp_price,
                    "sl_price": sl_price,
                    "sl_config_last_level": sl_config_last_level
                }
            )
